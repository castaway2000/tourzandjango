...
class ServiceInOrderViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        qs = ServiceInOrder.objects.filter(order__guide__user=user)
        return qs
...
class ReviewViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        user = self.request.user
        qs = Review.objects.filter(Q(order__guide__user=user)|Q(order__tourist__user=user))
        return qs
...
class OrderViewSet(viewsets.ModelViewSet):
    ...
    #it is also used for providing initial objects for get_object method
    def get_queryset(self):
        user = self.request.user
