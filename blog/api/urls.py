...
router.register(r'blog_tags', views.BlogTagViewSet)
router.register(r'blog_category', views.BlogCategoryViewSet)
router.register(r'blog_post_tags', views.BlogPostTagViewSet)
